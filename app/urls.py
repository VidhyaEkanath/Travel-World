...
urlpatterns = [
    ...
    path('userpage/' , v.userpage , name="userpage"),
    ...
    path('userbookingpackages/<int:package_id>/packagess/' , v.userbookingpackages , name="bookedpackage"),
    path('userpackages/' , v.userpackages , name="bookpackageview"),
]
